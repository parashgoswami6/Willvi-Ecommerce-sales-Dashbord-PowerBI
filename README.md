...
Geographic Analysis: A state-wise breakdown of sales and profit, identifying high-performing regions like Gujarat, Bihar, and Delhi.
Product Performance: Analysis of sales by category (Clothing, Electronics, Furniture) and sub-categories (Printers, Bookcases, etc.) to identify top-selling products.
...
Preferred Payment: Cash on Delivery (44%) remains the most popular payment mode, followed by UPI (21%).
Profitability: While sales are high in multiple categories, the Printers sub-category shows the highest profit margins.
Regional Growth: Markets in Gujarat and Bihar are showing significant upward trends in quantity ordered.
🚀 How to Use this Project
Download the WILLVI ECOMMERCE SALLS DATA.pbix file from this repository.
Install Power BI Desktop on your system.
Open the file to interact with the filters (Slicers) for Year, Quarter, and Region to see dynamic updates.
📬 Contact
Parash Goswami Computer Science Engineering Student  [parasgos974@gmail.com]
